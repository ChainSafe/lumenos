...
#include <stdlib.h>
#include <stdio.h>
#include "c/vdec/vdec_wrapper.h" // Provides VdecProof, VdecLnpTbox, verify_vdec_lnp_tbox, etc.
...
extern void FreeVdecProof(VdecProof *proof);
...
func CallVdecProver(seed []byte, params bgv.Parameters, sk *rlwe.SecretKey, ct *rlwe.Ciphertext, m bgv.IntegerSlice) C.VdecProof {
	C.lazer_init()
